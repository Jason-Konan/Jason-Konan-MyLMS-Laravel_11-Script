...
return [
    ...
    */
    ...
    'default' => env('MAIL_MAILER', config('mail.default') ?? 'smtp'),
    'mailers' => [
        'smtp' => [
            'transport' => 'smtp',
            'host' => env('MAIL_HOST', config('mail.mailers.smtp.host') ?? 'smtp.gmail.com'),
            'port' => env('MAIL_PORT', config('mail.mailers.smtp.port') ?? 587),
    ...
    'from' => [
        'address' => env('MAIL_FROM_ADDRESS', config('mail.from.address') ?? 'hello@example.com'),
