<x-admin-layout title="My profile">
    <h1 class="text-4xl text-center font-bold">Profile</h1>
        ...
        <form action="{{ route('admin.updatePassword') }}" method="POST">
            ...
            <div class="space-y-12">
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <p class="mt-1 text-sm leading-6 text-gray-600">Vous pouvez modifier votre mot de passe pour vos
                        futures connexions.</p>

                    <div class="mt-10 space-y-4 md:w-2/3">
